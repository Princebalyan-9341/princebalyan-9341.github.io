document.addEventListener("DOMContentLoaded", function () {
  ...
  var scene = new ScrollMagic.Scene({
    ...
    // Profile Picture 
    // var profilePhotoTween = TweenMax.from("#profile-photo", 1, { opacity: 0, y: 50 });
    var profilePhotoTween = TweenMax.from("#profile-photo", 1,
    { opacity: 0, x: 100 },
    { opacity: 1, x: 0 });


// Create a ScrollMagic scene for the animation
var profilePhotoScene = new ScrollMagic.Scene({
    triggerElement: '#about', // Adjust this based on where you want the animation to start
    triggerHook: 0.8, // Adjust this to determine when the animation starts relative to the viewport
  ...
  var experienceTween = TweenMax.staggerFrom(
    "#experience ul li",
    0.5,
    { opacity: 0, y: 20 },
    0.2
  ...
  var projectsTween = TweenMax.staggerFrom(
    "#projects div",
    0.5,
    { opacity: 0, x: -50 },
    0.2
  ...
  var certificationsTween = TweenMax.staggerFrom(
  ...
  var awardsTween = TweenMax.staggerFrom(
    "#awards ul li",
    0.5,
    { opacity: 0, x: -50 },
    0.2
  ...
  var skillsTween = TweenMax.staggerFrom(
    "#skills ul li",
    0.5,
    { opacity: 0, y: 20 },
    0.2
  ...
  var educationTween = TweenMax.staggerFrom(
    "#education div",
    0.5,
    { opacity: 0, x: -50 },
    0.2
  ...
  var strengthsTween = TweenMax.staggerFrom(
    "#strengths ul li",
    0.5,
    { opacity: 0, y: 20 },
    0.2
  ...
  var interestsTween = TweenMax.staggerFrom(
    "#interests ul li",
    0.5,
    { opacity: 0, x: -50 },
    0.2
